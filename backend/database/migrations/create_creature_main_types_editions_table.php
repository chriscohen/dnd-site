...
return new class extends Migration
{
    ...
    {
        Schema::create('creature_main_type_editions', function (Blueprint $table) {
            ...
            $table->unique(['creature_main_type_id', 'game_edition'], 'creature_edition_unique');
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('creature_main_type_editions');
    }
};
