...
readonly class CreatureTypeFullDTO extends CreatureTypeSummaryDTO
{
    public function __construct(
        ...
        public readonly ?CreatureTypeSummaryDTO $parent = null,
        /** @var Collection<CreatureTypeSummaryDTO> $children */
    ...
    public static function fromModel(object $model): static
    {
        return new static(
            ...
            editions: $model->relationLoaded('editions') ?
                ...
                null,
            parent: $model->parent ? CreatureTypeSummaryDTO::fromModel($model->parent) : null,
            children: $model->relationLoaded('children') ?
                $model->children->map(fn (CreatureType $item) => CreatureTypeSummaryDTO::fromModel($item)) :
                null
        );
    }
}
